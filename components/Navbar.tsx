        ...
        <div className="flex items-center gap-6">
          ...
          <div className="relative">
            <button
              ...
              className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors text-sm flex items-center gap-1"
            >
              GitHub
                ...
                >
                  <div className="p-2">
                    <a
                      ...
                      className="flex items-center gap-3 p-3 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors rounded"
                    >
                      <div className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center">
                        <svg className="w-4 h-4 text-gray-700 dark:text-white" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="text-left">
                        <div className="text-sm text-gray-900 dark:text-white font-medium">MCP Server</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">Protocol implementation</div>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div className="text-left">
                        <div className="text-sm text-gray-900 dark:text-white font-medium">Website</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">This site&apos;s source code</div>
                      </div>
                    </a>
                  </div>
                </motion.div>
          ...
          {wallet.connected ? (
            <div className="relative">
              <motion.button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-600/20 border border-green-300 dark:border-green-500/50 text-green-700 dark:text-green-400 font-medium text-sm hover:bg-green-200 dark:hover:bg-green-600/30 transition-colors rounded-lg"
                ...
                {showWalletMenu && (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full p-3 text-left text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors rounded-b-lg"
                    >
                      Disconnect
                    </button>
                  </motion.div>
