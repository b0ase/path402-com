...
export const metadata: Metadata = {
  title: 'DNS vs SDK: The x402 Question — $402',
  ...
  openGraph: {
    ...
    description: 'Coinbase built an SDK for HTTP 402 payments. We built three DNS records. Here\'s why DNS wins.',
    url: 'https://path402.com/blog/dns-vs-sdk',
    siteName: '$402',
  },
  twitter: {
      ...
      <div className="border-t border-zinc-800 bg-zinc-950">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            ...
            <a href="https://path402.com" className="block border border-green-500/30 rounded p-4 bg-green-500/5">
            ...
            <a href="https://path403.com" className="block border border-zinc-800 rounded p-4 hover:border-green-500/30 transition-colors">
