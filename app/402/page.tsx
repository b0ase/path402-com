  ...
  return (
    <div className="min-h-screen bg-white pt-20 pb-16">
      ...
      <div className="fixed top-24 right-6 z-40 print:hidden">
        <button
          onClick={downloadPDF}
          className="flex items-center gap-2 px-4 py-2 bg-gray-900 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors shadow-lg"
        >
      ...
      {/* Whitepaper Content */}
      <div ref={contentRef} className="max-w-[800px] mx-auto px-8 font-serif">
        ...
        <header className="text-center mb-12 pt-8">
          ...
          <p className="text-base text-gray-600">
            Richard Boase<br />
            <a href="mailto:hello@b0ase.com" className="text-blue-600 hover:underline">hello@b0ase.com</a><br />
            <a href="https://b0ase.com" className="text-blue-600 hover:underline">b0ase.com</a>
          </p>
        ...
        <section className="mb-10">
          <h2 className="text-center text-sm font-bold uppercase tracking-wider mb-4">Abstract</h2>
          <p className="text-justify text-[15px] leading-relaxed indent-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-justify text-[15px] leading-relaxed mb-3">
          ...
          <ul className="list-disc list-inside text-[15px] leading-relaxed mb-3 ml-4">
          ...
          <p className="text-justify text-[15px] leading-relaxed">
        ...
        {/* 2. The Problem */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3">2. The Problem</h2>

          <h3 className="text-base font-bold mb-2">2.1 Broken Monetization Models</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
          ...
          <h3 className="text-base font-bold mb-2">2.2 The AI Agent Problem</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
          ...
          <h3 className="text-base font-bold mb-2">2.3 The HTTP 402 Void</h3>
          <p className="text-justify text-[15px] leading-relaxed">
        ...
        {/* 3. The $402 Solution */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3">3. The $402 Solution</h2>

          <h3 className="text-base font-bold mb-2">3.1 Core Concept: $addresses</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
            The $402 protocol introduces <em>$addresses</em>—URL paths prefixed with $ that represent
            tokenized content markets:
          </p>
          <pre className="bg-gray-100 p-4 rounded text-sm mb-4 overflow-x-auto font-mono">
...
$example.com/$api/$premium   → Content token`}
          ...
          <h3 className="text-base font-bold mb-2 mt-4">3.2 HTTP 402 Response</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
...

{
  ...
  "accepts": ["bsv", "base", "sol", "eth"]
          ...
          <h3 className="text-base font-bold mb-2">3.3 Discovery Protocol</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
            All $402-compliant servers expose <code className="bg-gray-100 px-1 rounded font-mono text-sm">/.well-known/x402.json</code> containing
        ...
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3">4. Unilateral Contract Theory</h2>

          <blockquote className="border-l-4 border-gray-400 pl-4 my-4 italic text-gray-700 text-[15px]">
          ...
          <h3 className="text-base font-bold mb-2">4.1 The $402 Offer</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
          ...
          <h3 className="text-base font-bold mb-2">4.2 Binding Through Performance</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
        ...
        {/* 5. Token Economics */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3">5. Token Economics</h2>

          <h3 className="text-base font-bold mb-2">5.1 sqrt_decay Pricing Model</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
          ...
          <h3 className="text-base font-bold mb-2 mt-4">5.2 Price Schedule</h3>
          ...
          <h3 className="text-base font-bold mb-2">5.3 Revenue Distribution</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
...
{`"revenue_split": {
  ...
  "facilitator_bps": 2000  // 20% to platform
        ...
        {/* 6. x402 Facilitator */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3">6. x402 Facilitator Protocol</h2>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
          ...
          <h3 className="text-base font-bold mb-2">6.1 Multi-Chain Support</h3>
          ...
          <h3 className="text-base font-bold mb-2">6.2 Verification Flow</h3>
          <pre className="bg-gray-100 p-4 rounded text-sm mb-4 overflow-x-auto font-mono">
...
8. Server: Verify with facilitator, deliver content`}
        ...
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3">7. AI Agent Integration</h2>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
          ...
          <h3 className="text-base font-bold mb-2">7.1 MCP Tools</h3>
          <table className="w-full text-sm border-collapse mb-4">
            <thead>
              <tr className="border-b-2 border-gray-300">
                <th className="text-left py-2 pr-4 font-mono">Tool</th>
                <th className="text-left py-2">Purpose</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-200">
                <td className="py-2 pr-4 font-mono text-blue-600">path402_discover</td>
                <td className="py-2">Probe URL, get pricing and token info</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="py-2 pr-4 font-mono text-blue-600">path402_evaluate</td>
                <td className="py-2">Check budget, estimate value</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="py-2 pr-4 font-mono text-blue-600">path402_acquire</td>
                <td className="py-2">Pay and receive token + content</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="py-2 pr-4 font-mono text-blue-600">x402_verify</td>
                <td className="py-2">Verify payment from any chain</td>
              </tr>
              <tr>
                <td className="py-2 pr-4 font-mono text-blue-600">x402_inscription</td>
                <td className="py-2">Get BSV proof for payment</td>
              </tr>
            </tbody>
          </table>
        </section>
        ...
        {/* 8. Investment Thesis */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3">8. Investment Thesis</h2>

          <h3 className="text-base font-bold mb-2">8.1 Market Opportunity</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
          ...
          <h3 className="text-base font-bold mb-2">8.2 Competitive Moat</h3>
          <ul className="list-disc list-inside text-[15px] leading-relaxed mb-3 ml-4">
          ...
          <h3 className="text-base font-bold mb-2">8.3 Revenue Model</h3>
          <table className="w-full text-sm border-collapse mb-4">
            <tbody>
              <tr className="border-b border-gray-200">
                <td className="py-2 pr-4 text-gray-600">Facilitator fee</td>
                <td className="py-2 font-mono">20% (2000 bps)</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="py-2 pr-4 text-gray-600">Verification fee</td>
                <td className="py-2 font-mono">200 sats</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="py-2 pr-4 text-gray-600">Inscription fee</td>
                <td className="py-2 font-mono">500 sats</td>
              </tr>
              <tr>
                <td className="py-2 pr-4 text-gray-600">Settlement fee</td>
        ...
        {/* 9. Roadmap */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3">9. Roadmap</h2>

          <div className="space-y-3 text-[15px]">
            <div className="flex gap-4">
              <span className="font-bold text-green-700 w-20">Q1 2026</span>
              <span>Protocol specification, MCP server v1.0.0, x402 facilitator ✓</span>
            </div>
            <div className="flex gap-4">
              <span className="font-bold text-blue-700 w-20">Q2 2026</span>
              <span>Token exchange UI, global $address registry, creator tools</span>
            </div>
            <div className="flex gap-4">
              <span className="font-bold text-purple-700 w-20">Q3 2026</span>
              <span>Agent SDK, self-funding agent templates, agent marketplace</span>
            </div>
            <div className="flex gap-4">
              <span className="font-bold text-gray-700 w-20">Q4 2026</span>
        ...
        {/* 10. Conclusion */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3">10. Conclusion</h2>
          <p className="text-justify text-[15px] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          ...
          <ol className="list-decimal list-inside text-[14px] leading-relaxed space-y-1">
        ...
        <footer className="border-t border-gray-300 pt-4 mt-8 text-sm text-gray-500">
          <p>
            ...
            <a href="https://github.com/b0ase/path402-com/blob/main/LICENSE" className="text-blue-600 hover:underline">
              Open BSV License version 4
            </a>.
          </p>
          <p className="mt-2">
            Version 1.0.0 · February 2026 · <a href="https://path402.com" className="text-blue-600 hover:underline">path402.com</a>
          </p>
        </footer>
