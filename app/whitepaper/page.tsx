  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 pt-20 pb-16">
      ...
      <div className="max-w-[800px] mx-auto px-8 font-serif text-gray-900 dark:text-gray-100">
        ...
        {/* 2. The Problem */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">2. The Problem</h2>

          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">2.1 Broken Monetization Models</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">2.2 The AI Agent Problem</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">2.3 The HTTP 402 Void</h3>
          <p className="text-justify text-[15px] leading-relaxed text-gray-800 dark:text-gray-200">
        ...
        {/* 3. The $402 Solution */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">3. The $402 Solution</h2>

          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">3.1 Core Concept: $addresses</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
            The $402 protocol introduces <em>$addresses</em>—URL paths prefixed with $ that represent
            tokenized content markets:
          </p>
          <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded text-sm mb-4 overflow-x-auto font-mono text-gray-800 dark:text-gray-200">
...
$example.com/$api/$premium   → Content token`}
          ...
          <h3 className="text-base font-bold mb-2 mt-4 text-gray-900 dark:text-white">3.2 HTTP 402 Response</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
...

{
  ...
  "accepts": ["bsv", "base", "sol", "eth"]
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">3.3 Discovery Protocol</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
            All $402-compliant servers expose <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded font-mono text-sm text-gray-800 dark:text-gray-200">/.well-known/x402.json</code> containing
        ...
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">4. Unilateral Contract Theory</h2>

          <blockquote className="border-l-4 border-gray-400 dark:border-gray-600 pl-4 my-4 italic text-gray-700 dark:text-gray-300 text-[15px]">
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">4.1 The $402 Offer</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">4.2 Binding Through Performance</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
        ...
        {/* 5. Token Economics */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">5. Token Economics</h2>

          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">5.1 sqrt_decay Pricing Model</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
            The default pricing model uses square root decay based on remaining treasury:
          </p>
          <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded mb-4 text-center">
            <p className="font-mono text-lg mb-2 text-gray-900 dark:text-white">
          ...
          <h3 className="text-base font-bold mb-2 mt-4 text-gray-900 dark:text-white">5.2 Price Schedule</h3>
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">5.3 Revenue Distribution</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
...
{`"revenue_split": {
  ...
  "facilitator_bps": 2000  // 20% to platform
        ...
        {/* 6. x402 Facilitator */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">6. x402 Facilitator Protocol</h2>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">6.1 Multi-Chain Support</h3>
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">6.2 Verification Flow</h3>
          <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded text-sm mb-4 overflow-x-auto font-mono text-gray-800 dark:text-gray-200">
...
8. Server: Verify with facilitator, deliver content`}
        ...
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">7. AI Agent Integration</h2>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">7.1 MCP Tools — Discovery & Evaluation</h3>
          <table className="w-full text-sm border-collapse mb-4">
            <thead>
              <tr className="border-b-2 border-gray-300 dark:border-gray-600">
                <th className="text-left py-2 pr-4 font-mono text-gray-900 dark:text-white">Tool</th>
                <th className="text-left py-2 text-gray-900 dark:text-white">Purpose</th>
              </tr>
            </thead>
            <tbody className="text-gray-800 dark:text-gray-200">
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_discover</td>
                <td className="py-2">Probe $address — get pricing, supply, revenue model</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_batch_discover</td>
                <td className="py-2">Discover multiple $addresses simultaneously</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_evaluate</td>
                <td className="py-2">Assess ROI viability before purchasing</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_economics</td>
                <td className="py-2">Analyze breakeven points and projections</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_price_schedule</td>
                <td className="py-2">View price curve across supply levels</td>
              </tr>
            </tbody>
          </table>

          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">7.2 MCP Tools — Acquisition & Wallet</h3>
          <table className="w-full text-sm border-collapse mb-4">
            <thead>
              <tr className="border-b-2 border-gray-300 dark:border-gray-600">
                <th className="text-left py-2 pr-4 font-mono text-gray-900 dark:text-white">Tool</th>
            ...
            <tbody className="text-gray-800 dark:text-gray-200">
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_acquire</td>
                <td className="py-2">Pay and receive token + gated content</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_set_budget</td>
                <td className="py-2">Configure agent spending parameters</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_wallet</td>
                <td className="py-2">View balance, holdings, net position</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_transfer</td>
                <td className="py-2">Transfer tokens to another address</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_history</td>
                <td className="py-2">View transaction history</td>
              </tr>
            </tbody>
          </table>

          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">7.3 MCP Tools — Serving & Revenue</h3>
          <table className="w-full text-sm border-collapse mb-4">
            <thead>
              <tr className="border-b-2 border-gray-300 dark:border-gray-600">
                <th className="text-left py-2 pr-4 font-mono text-gray-900 dark:text-white">Tool</th>
            ...
            <tbody className="text-gray-800 dark:text-gray-200">
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_serve</td>
                <td className="py-2">Distribute content and earn revenue</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_servable</td>
                <td className="py-2">List all servable content with stats</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-blue-600 dark:text-blue-400">path402_register</td>
                <td className="py-2">Register new $address as issuer</td>
              </tr>
            </tbody>
          </table>

          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">7.4 x402 Facilitator Tools</h3>
          <table className="w-full text-sm border-collapse mb-4">
            <thead>
              <tr className="border-b-2 border-gray-300 dark:border-gray-600">
                <th className="text-left py-2 pr-4 font-mono text-gray-900 dark:text-white">Tool</th>
            ...
            <tbody className="text-gray-800 dark:text-gray-200">
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-green-600 dark:text-green-400">x402_verify</td>
                <td className="py-2">Verify payment proof from any chain</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-green-600 dark:text-green-400">x402_settle</td>
                <td className="py-2">Settle cross-chain payment via facilitator</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 font-mono text-green-600 dark:text-green-400">x402_inscription</td>
        ...
        {/* 8. Investment Thesis */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">8. Investment Thesis</h2>

          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">8.1 Market Opportunity</h3>
          <p className="text-justify text-[15px] leading-relaxed mb-3 text-gray-800 dark:text-gray-200">
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">8.2 Competitive Moat</h3>
          <ul className="list-disc list-inside text-[15px] leading-relaxed mb-3 ml-4 text-gray-800 dark:text-gray-200">
          ...
          <h3 className="text-base font-bold mb-2 text-gray-900 dark:text-white">8.3 Revenue Model</h3>
          <table className="w-full text-sm border-collapse mb-4">
            <tbody>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 text-gray-600 dark:text-gray-400">Facilitator fee</td>
                <td className="py-2 font-mono">20% (2000 bps)</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 text-gray-600 dark:text-gray-400">Verification fee</td>
                <td className="py-2 font-mono">200 sats</td>
              </tr>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <td className="py-2 pr-4 text-gray-600 dark:text-gray-400">Inscription fee</td>
                <td className="py-2 font-mono">500 sats</td>
              </tr>
              <tr>
                <td className="py-2 pr-4 text-gray-600 dark:text-gray-400">Settlement fee</td>
        ...
        {/* 9. Roadmap */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">9. Roadmap</h2>
        ...
        {/* References */}
        <section className="mb-8">
          <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">References</h2>
        ...
        {/* Footer */}
        <footer className="border-t border-gray-300 dark:border-gray-700 pt-4 mt-8 text-sm text-gray-500 dark:text-gray-400">
          <p>
            This whitepaper is released under the{' '}
            <a href="https://github.com/b0ase/path402-com/blob/main/LICENSE" className="text-blue-600 dark:text-blue-400 hover:underline">
