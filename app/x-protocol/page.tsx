...
export const metadata: Metadata = {
  title: '$402 — The X Protocol: x401 / x402 / x403',
  ...
  openGraph: {
    ...
    url: 'https://path402.com/x-protocol',
    siteName: '$402',
  },
  twitter: {
      ...
      <div className="sticky top-0 z-50 border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-black/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-3 py-3 flex items-center justify-between">
          ...
          <a
            ...
            className="text-[9px] font-mono text-blue-500 hover:text-blue-400 uppercase tracking-widest transition-colors"
          >
          ...
          <div className="border border-zinc-800 bg-zinc-950 p-4 rounded text-left font-mono text-[10px] space-y-1.5">
            <div className="flex gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-500 hover:text-blue-400 break-all transition-colors"
              >
